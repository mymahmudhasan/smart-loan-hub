...
export const translations: Dict = {
  ...
  hero_cta_secondary: { en: "Calculate EMI", bn: "কিস্তি হিসাব" },
  ...
  step4_d: { en: "Track EMIs and clear your loan with ease.", bn: "কিস্তি ট্র্যাক করে সহজে লোন পরিশোধ করুন।" },
  ...
  refer_s3_t: { en: "They deposit & upgrade", bn: "তারা ডিপোজিট করে ও আপগ্রেড করে" },
  refer_s3_d: { en: "When they make a deposit and upgrade their membership, it counts as 1 referral.", bn: "তারা ডিপোজিট করে মেম্বারশিপ আপগ্রেড করলে সেটি ১টি রেফারেল হিসেবে গণনা হয়।" },
  refer_s4_t: { en: "You earn ৳500", bn: "আপনি পান ৳৫০০" },
  refer_s4_d: { en: "৳500 is added to your referral rewards balance.", bn: "৳৫০০ আপনার রেফারেল রিওয়ার্ড ব্যালেন্সে যোগ হয়।" },
  refer_cta: { en: "Start referring", bn: "রেফার শুরু করুন" },
  live_title: { en: "Live Deposits", bn: "লাইভ ডিপোজিট" },
  live_streaming: { en: "streaming", bn: "স্ট্রিমিং" },
  live_subtitle: { en: "Members are depositing right now", bn: "সদস্যরা এখনই ডিপোজিট করছেন" },
  live_now: { en: "just now", bn: "এইমাত্র" },
  live_sec_ago: { en: "s ago", bn: " সেকেন্ড আগে" },
  live_min_ago: { en: "m ago", bn: " মিনিট আগে" },
  live_badge_membership: { en: "Membership", bn: "মেম্বারশিপ" },
  live_badge_emi: { en: "EMI", bn: "কিস্তি" },
  live_badge_savings: { en: "Savings", bn: "সঞ্চয়" },
  ...
  calc_subtitle: { en: "Estimate your monthly EMI and total cost.", bn: "আপনার মাসিক কিস্তি ও মোট খরচ হিসাব করুন।" },
  calc_amount: { en: "Loan Amount", bn: "লোনের পরিমাণ" },
  calc_duration: { en: "Duration (months)", bn: "মেয়াদ (মাস)" },
  calc_emi: { en: "Monthly EMI", bn: "মাসিক কিস্তি" },
  ...
  dash_due: { en: "Next EMI Due", bn: "পরবর্তী কিস্তি" },
  dash_eligibility: { en: "Loan Eligibility", bn: "লোন যোগ্যতা" },
  dash_emi_progress: { en: "EMI Progress", bn: "কিস্তি অগ্রগতি" },
  ...
  pay_emi: { en: "Pay EMI", bn: "কিস্তি দিন" },
  ...
  wa_widget_greeting: {
    ...
    bn: "হ্যালো! লোন, জমা, কিস্তি বা আপনার একাউন্ট নিয়ে সাহায্য করতে আমরা আছি। নিচে থেকে একটি বিষয় বেছে নিন বা মেসেজ পাঠান।",
  },
